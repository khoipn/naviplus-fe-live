 ...
 * https://cdn.jsdelivr.net/gh/khoipn/naviplus-fe-live@main/live-189/uigen.min.js
 * THÌ LẤY PHIÊN BẢN THEO CÁI NÀY **/
// var uigenJsScriptUrl = "https://cdn.jsdelivr.net/gh/khoipn/naviplus-fe-live@main/live-189/uigen.min.js";
...
/**********************************************************************************/
// Lấy các đường dẫn đến các CDN khác nhau. hiện tại sẽ quy hết về golive.naviplus.app/live/{version}
/**********************************************************************************/
...
var cdn_golive_cloudflare_page = 'https://golive.naviplus.app/live'; // Dùng cho LIVE (Cloudflare Pages)

var naviplusCss = cdn_golive_cloudflare_page + '/'+ naviman_version +'/uigen.min.css';
    ...
    function runApplication(shopinfo) {
        ...
        if( isNeedRequestServer ) {
            fetch(api_url + "?v=" + window._naviVer )
                ...
                .then((json) => {
                    navidebug.log( "[Server]", api_url, json );
