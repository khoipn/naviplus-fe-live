...
Animation.Tabbar._applyTabbarCoverBackground = function(tabbarEl) {
    ...
    [].forEach.call(innerEls, function(el) {
        ...
        /* Ưu tiên màu li.item (item set màu riêng), không có thì tìm lên DOM */
        ...
        /* Copy border-radius từ li.item → .inner để giữ góc bo tròn trong suốt animation.
         * CSS border-radius trên cha không tự clip con — phải set trực tiếp trên .inner. */
        if (itemEl) {
...
Animation.Tabbar.openSubLevel = function(submenuElement, options) {
    ...
    if (initialTransform) {
        ...
        var cleanupBg = isMobile ? Animation.Tabbar._applyTabbarCoverBackground(options.tabbarEl) : function() {};
